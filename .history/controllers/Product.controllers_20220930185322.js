...
exports.bulkUpdatedProductServices = async (req, res, next) => {
  
  try {
    const bulkUpdatedProduct = await bulkUpdateProductService(id,req.body)
    
    res.status(200).json({
      status: "Success",
      message:"Bulk Product Updated Succesffully"
    })
